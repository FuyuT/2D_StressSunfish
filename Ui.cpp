...
void CUi::Render(int parasiteNum, int hungry, float tempRegionNum, double distanceNum, bool jumpFlg, bool eatFlg, bool tutorialFlg,int eventNum,int posy,float wy)
{
	...
	CGraphicsUtilities::RenderString(500, 100, MOF_COLOR_BLACK, "%1.0 : %1.0f", mousePos.x,mousePos.y);
	parasite1.RenderScale(mousePos.x, PlayerPosY - wy + mousePos.y, 0.4f);
	...
	case 1:
		...
		parasite1.RenderScale(PlayerPosX = 440 , PlayerPosY - wy+ 130,0.4f);
		break;
	case 2:
		parasite2.Render(stressMeterFramePos.x + 22, stressMeterFramePos.y + 21);
		parasite1.RenderScale(PlayerPosX = 440, PlayerPosY - wy + 130, 0.4f);
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy +140,0.4f);
		break;
	case 3:
		parasite3.Render(stressMeterFramePos.x + 22, stressMeterFramePos.y + 21);
		parasite1.RenderScale(PlayerPosX = 440, PlayerPosY - wy+130, 0.4f);
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy + 140, 0.4f);
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.4f);
		break;
	case 4:
		parasite4.Render(stressMeterFramePos.x + 22, stressMeterFramePos.y + 21);
		parasite1.RenderScale(PlayerPosX = 445, PlayerPosY - wy+130, 0.4f);
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy +140, 0.4f);
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.4f);
		parasite1.RenderScale(PlayerPosX = 480, PlayerPosY - wy +180, 0.4f);
	...
	case 5:
		...
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.4f);
		parasite1.RenderScale(PlayerPosX = 480, PlayerPosY - wy +180, 0.4f);
		parasite1.RenderScale(PlayerPosX = 435, PlayerPosY - wy +120, 0.4f);
		break;
	}
