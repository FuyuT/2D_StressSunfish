...
void CUi::Render(int parasiteNum, int hungry, float tempRegionNum, double distanceNum, bool jumpFlg, bool eatFlg, bool tutorialFlg,int eventNum,int posy,float wy)
{
	...
	case 1:
		...
		parasite1.RenderScale(PlayerPosX = 425 , PlayerPosY - wy+ 115,0.48f);
		break;
	case 2:
		parasite2.Render(stressMeterFramePos.x + 22, stressMeterFramePos.y + 21);
		parasite1.RenderScale(PlayerPosX = 425, PlayerPosY - wy + 115, 0.48f);
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy +140,0.48f);
		break;
	case 3:
		parasite3.Render(stressMeterFramePos.x + 22, stressMeterFramePos.y + 21);
		parasite1.RenderScale(PlayerPosX = 425, PlayerPosY - wy+ 115, 0.48f);
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy + 140, 0.48f);
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.48f);
		break;
	case 4:
		...
		parasite1.RenderScale(PlayerPosX = 465, PlayerPosY - wy +140, 0.48f);
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.48f);
		parasite1.RenderScale(PlayerPosX = 480, PlayerPosY - wy +180, 0.48f);
	...
	case 5:
		...
		parasite1.RenderScale(PlayerPosX = 420, PlayerPosY - wy +160, 0.48f);
		parasite1.RenderScale(PlayerPosX = 480, PlayerPosY - wy +180, 0.48f);
		parasite1.RenderScale(PlayerPosX = 485, PlayerPosY - wy +110, 0.48);
		break;
	}
